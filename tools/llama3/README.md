### NOTE: these scripts are copied over from [PR 174 by Toni](https://github.com/huggingface/nanotron/pull/174), only updated to use the latest version of nanotron.
